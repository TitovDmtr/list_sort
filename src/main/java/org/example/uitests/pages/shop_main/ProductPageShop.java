...
public class ProductPageShop extends BasePage {
    ...
    @FindBy(id = "nb_item")
    private WebElement productPerPage;
    ...
    public ProductPageShop showPerPage(ProductsPerPage productsPerPage) throws InterruptedException {
        Select select = new Select(productPerPage);
        select.selectByValue(productsPerPage.getValue());
        sleep(2500);
        return new ProductPageShop();
    }
}